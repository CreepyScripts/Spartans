...
namespace Spartan_Annie
{
    internal class Program
    {
        ...
        public static void OnLoaded(EventArgs args)
        {
            ...
            AnnieMenu = MainMenu.AddMenu("SpartanAnnie", "spartanannie");
            AnnieMenu.AddGroupLabel("Spartan.Annie");
            AnnieMenu.AddSeparator();
            AnnieMenu.AddLabel("Spartan Annie -  Version.ThisIsSparta");

            ComboMenu = AnnieMenu.AddSubMenu("Go Spartan on His Ass (Combo)", "sbtw");
            ComboMenu.AddGroupLabel("Combo Settings");
            ComboMenu.AddSeparator();
            ComboMenu.Add("usecomboq", new CheckBox("Q That Bitch"));
            ComboMenu.Add("usecombow", new CheckBox("W That Bitch"));
            ComboMenu.Add("usecomboe", new CheckBox("E That Bitch"));
            ComboMenu.Add("usecombor", new CheckBox("Ult That Bitch"));
            ComboMenu.Add("useignite", new CheckBox("Ignite That Bitch"));
            ComboMenu.Add("comboOnlyExhaust", new CheckBox("Exhaust That Bitch (Combo Only)"));
            ComboMenu.AddSeparator();
            ComboMenu.Add("rslider", new Slider("Minimum people for [R]apage", 2, 0, 5));
            ComboMenu.AddSeparator();
            ComboMenu.Add("flashr", new KeyBind("Flash [R]ape", false, KeyBind.BindTypes.HoldActive, 'Y'));
            ComboMenu.Add("flasher", new KeyBind("Spartan Mode: Flash+E+Rape", false, KeyBind.BindTypes.HoldActive, 'N'));
            

            DrawMenu = AnnieMenu.AddSubMenu("Spartan: Drawings", "drawings");
            DrawMenu.AddGroupLabel("Drawings");
            DrawMenu.AddSeparator();
            DrawMenu.Add("drawq", new CheckBox("Draw Q Range"));
            DrawMenu.Add("draww", new CheckBox("Draw W Range"));
            DrawMenu.Add("drawr", new CheckBox("Draw [R]ape Range"));
            DrawMenu.Add("drawaa", new CheckBox("Draw AA Range"));
            DrawMenu.Add("drawtf", new CheckBox("Draw Teddy Rape-age, Flash Range"));

            LastHit = AnnieMenu.AddSubMenu("Spartan: Last Hit", "lasthit");
            LastHit.AddGroupLabel("Last Hit Settings");
            LastHit.Add("LHQ", new CheckBox("Use Q"));

            LaneJungleClear = AnnieMenu.AddSubMenu("Spartan: Jungle Camps", "lanejungleclear");
            LaneJungleClear.AddGroupLabel("Jungle Clear Settings");
            LaneJungleClear.Add("LCQ", new CheckBox("Use Q"));
            LaneJungleClear.Add("LCW", new CheckBox("Use W"));

            MiscMenu = AnnieMenu.AddSubMenu("Spartan: Steal Kills Like a Pro", "miscmenu");
            MiscMenu.AddGroupLabel("MISC");
            MiscMenu.AddSeparator();
            MiscMenu.Add("ksq", new CheckBox("Killsteal using Q"));
            MiscMenu.Add("ksw", new CheckBox("Killsteal using W"));
            MiscMenu.Add("ksr", new CheckBox("Killsteal using [R]ape"));
            MiscMenu.Add("ksignite", new CheckBox("Killsteal using Ignite"));
            
			
            MiscMenu = AnnieMenu.AddSubMenu("Spartan: Misc", "miscmenu");
            MiscMenu.AddGroupLabel("MISC1");
		    MiscMenu.Add("estack", new CheckBox("Stack Passive with E", false));
            MiscMenu.Add("wstack", new CheckBox("Stack Passive with W ", false));
            ...
            MiscMenu.AddSeparator();
            MiscMenu.Add("zhonias", new CheckBox("Use Zhonya when getting raped?"));
            MiscMenu.Add("zhealth", new Slider("When Shall We Use Zhonya?", 8));
            MiscMenu.AddSeparator();
            ...
            MiscMenu.Add("lvlup", new CheckBox("Magically auto-level spells? [Way bettter]"));


            SkinMenu = AnnieMenu.AddSubMenu("Spartan: Skin Changer", "skin");
            SkinMenu.AddGroupLabel("You've got to look good when fucking others, right?");
